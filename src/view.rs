...
/// the same reason the dropdowns use `popup_dropdown` (see the popup-stack
/// rules in `AGENTS.md`). It pins the two non-obvious arguments: `parent_id` is
/// *our* popup, so the tooltip
